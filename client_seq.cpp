...
void get_from_chunkserver(string ,string ,string );
      ...
      //  write(data_buffer,sizeof(char),n,fp);
       ...
       // filesize=filesize-1024*512;
        ...
        while(i<v.size())
        {
            ...
            get_from_chunkserver(v[i],ip_port[i],filename);
...
void get_from_chunkserver(string chunk_indices,string ip_port,string filename )
{
